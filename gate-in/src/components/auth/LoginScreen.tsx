  ...
  return (
    <Container maxWidth="sm">
      ...
      >
        ...
        >
          <DirectionsCar color="primary" sx={{ fontSize: 64, mb: 2 }} />
          ...
          <Box component="form" onSubmit={handleSubmit} sx={{ width: '100%' }}>
            ...
            <FormControl fullWidth margin="normal" required>
              ...
              >
                ...
                <MenuItem value="vip-entrance">VIP Entrance</MenuItem>
                <MenuItem value="employee-entrance">Employee Entrance</MenuItem>
              </Select>
            </FormControl>
